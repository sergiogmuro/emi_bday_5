...
const layerList = [{
    ...baseConfig,
    src: './unicorn-re/background.png',
    zIndex: -3.5,
/*}, {
    ...baseConfig,
    src: './unicorn-re/spider-shadow-2.png',
    zIndex: -3,
    mode: 'isMoving',
    opacity: 1,
    blend: 'multiply',
    ...
    ...baseConfig,
    src: './unicorn-re/floorNew.png',
    zIndex: -3.3,
}, {
    ...baseConfig,
    src: './unicorn-re/shadows.png',
    zIndex: -3,
}, {
    ...baseConfig,
    src: './unicorn-re/dots-orange.png',
    zIndex: -2,
}, {
    ...baseConfig,
    src: './unicorn-re/guy.png',
    zIndex: -2,
}, {
    ...baseConfig,
    src: './unicorn-re/shadow-girl.png',
    zIndex: -2,
    mode: 'no-moving',*/
}, {
    ...baseConfig,
    src: './unicorn-re/stars.png',
    zIndex: -1,
    mode: 'isMoving',
    opacity: 1,
}, {
    ...baseConfig,
    src: './unicorn-re/separators.png',
    zIndex: -0.5,
}, {
    ...baseConfig,
    src: './unicorn-re/clouds-2.png',
    zIndex: 0,
}, {
    ...baseConfig,
    src: './unicorn-re/dots.png',
    zIndex: 0.8,
}, {
    ...baseConfig,
    src: './unicorn-re/texts.png',
/*    mode: 'isMoving',*/
    zIndex: 2.9,
}, {
    ...baseConfig,
    src: './unicorn-re/head.png',
    zIndex: 3,
}, {
    ...baseConfig,
    src: './unicorn-re/clouds-1.png',
    zIndex: 3.5,
}, {
    ...baseConfig,
    src: './unicorn-re/name.png',
    zIndex: 4,
}, ]
